@include('gigsboard.header')
   <head>
      ...
      <style>
        ...
        body{
          background: url('{{ asset('img/billimage.jpg')}}');
   ...
   <body>
      ...
      <section class="mt-3">
         ...
         <h2 class="text-center" style="color:black"><strong> Super Market Billing Software<strong> </h2>
         {{-- <h6 class="text-center"> Trichy.</h6> --}}
         <div class="row">
            ...
            <div class="col-md-7  mt-4" style="background-color:#53c6a7;">
               <div class="p-4">
